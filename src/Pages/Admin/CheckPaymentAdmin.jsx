    ...
    <div className="w-full text-white ">
      ...
      <table className=" text-center w-full mt-4 border-collapse">
        <tr className="bg-[#e26c22]">
          ...
          <th className="border-collapse border p-2">UPDATE BY</th>
        </tr>
          ...
          <td className="border-collapse border p-2">
            <form action="">
              <select
                name=""
                id=""
                className="bg-[#072212] border p-1 mx-4 rounded-lg"
              >
                <option value="">PENDING</option>
                <option value="">PAID</option>
              </select>
              <button className="bg-[#072212] border p-1 rounded-lg hover:bg-[#e26c22] hover:border-[#e26c22]">
                SUBMIT
              </button>
            </form>
          </td>
